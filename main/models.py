...
class Car(models.Model):
    ...
    BHP = models.IntegerField(null=True, blank=True)
...
class CarSubmission(models.Model):
    ...
    Transmission = models.ForeignKey(TransmissionType, on_delete=models.SET_NULL, null=True, blank=True)
    ServiceHistory = models.CharField(max_length=255, null=True, blank=True)
    ServiceBookPresent = models.CharField(max_length=255, null=True, blank=True)
    LastServiceDate = models.DateField(null=True, blank=True)
    LastServiceMileage = models.IntegerField(null=True, blank=True)
    NumberOfKeys = models.IntegerField(null=True, blank=True)
    IsTheCarModified = models.BooleanField(null=True, blank=True)
    TyreBrand = models.CharField(max_length=100, null=True, blank=True)
    TyreCondition = models.CharField(max_length=100, null=True, blank=True)
    ConditionDamageReport = models.CharField(max_length=255, null=True, blank=True)
    OutstandingFinance = models.CharField(max_length=100, null=True, blank=True)
    DesiredValue = models.IntegerField(null=True, blank=True)
